        ...
        <div class="postInfo-container">
          <el-row>
            <el-col :span="10">
              ...
              <el-form-item label-width="150px" :label="$t('customer.customerUser')" class="postInfo-container-item">
                <el-input v-model="postForm.customerUser" placeholder="账号，可与手机号一致"></el-input>
              </el-form-item>
              <el-form-item label-width="150px" :label="$t('customer.code')" class="postInfo-container-item">
                <el-input v-model="postForm.code" placeholder="请输入手机号码"></el-input>
              </el-form-item>
            ...
            <el-col :span="8">
              <el-form-item label-width="100px" :label="$t('customer.idCard')" class="postInfo-container-item">
                <el-input v-model="postForm.idCard" placeholder="请输入身份证"></el-input>
              </el-form-item>
              <el-form-item label-width="100px" :label="$t('customer.bank')" class="postInfo-container-item">
                <el-input v-model="postForm.bank" placeholder="请输入开户行"></el-input>
              </el-form-item>
              <el-form-item label-width="100px" :label="$t('customer.bankNo')" class="postInfo-container-item">
                <el-input v-model="postForm.bankNo" placeholder="请输入开户行账号"></el-input>
              </el-form-item>
              <el-form-item label-width="100px" :label="$t('customer.typeName')" class="postInfo-container-item">
                <el-select clearable v-model="postForm.type">
          ...
          <el-form-item label-width="150px" :label="$t('customer.address')">
            <el-input type="textarea"  :rows="5" placeholder="请输入内容" v-model="postForm.address" style="width: 500px">
            </el-input>
          </el-form-item>
        </div>
      </div>
